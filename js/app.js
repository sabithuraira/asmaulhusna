...
$(window).load(function() {
	...
	https://aladhan.com/
	list_view+='<li class="ui-group-index">Data source: https://aladhan.com/</li>'
	var ul_list = $("#list-data");
	ul_list.html(list_view);
	
	$('.pop_asma').on('click', function () {
//		console.log("tes")
	    var dataid = $(this).attr('id');
	    var current_data = data[dataid-1];
	    console.log(dataid);
	    ...
	    pop_header2.html(current_data.transliteration);
	    pop_body.html(current_data.en.meaning);
